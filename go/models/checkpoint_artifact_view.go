...
type CheckpointArtifactView struct {
	...
	residency ArtifactResidencyable
...
func (m *CheckpointArtifactView) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["residency"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateArtifactResidencyFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetResidency(val.(ArtifactResidencyable))
		}
		return nil
	}
...
func (m *CheckpointArtifactView) GetResidency() ArtifactResidencyable {
	return m.residency
}
...
func (m *CheckpointArtifactView) SetResidency(value ArtifactResidencyable) {
	m.residency = value
}
...
type CheckpointArtifactViewable interface {
	...
	GetProfileId() *string
	GetResidency() ArtifactResidencyable
	...
	SetResidency(value ArtifactResidencyable)
