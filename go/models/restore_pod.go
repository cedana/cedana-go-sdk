...
type RestorePod struct {
	...
	overrides RestoreOverridesable
	// The reason property
...
func (m *RestorePod) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["overrides"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateRestoreOverridesFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetOverrides(val.(RestoreOverridesable))
		}
		return nil
	}
...
func (m *RestorePod) GetOverrides() RestoreOverridesable {
	return m.overrides
}
...
func (m *RestorePod) SetOverrides(value RestoreOverridesable) {
	m.overrides = value
}
...
type RestorePodable interface {
	...
	GetActionId() *string
	GetClusterId() *string
	GetOverrides() RestoreOverridesable
	GetReason() *RestoreReason
	SetActionId(value *string)
	SetClusterId(value *string)
	SetOverrides(value RestoreOverridesable)
