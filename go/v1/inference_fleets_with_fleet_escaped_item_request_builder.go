...
// returns a HttpError error when the service returns a 404 status code
// returns a HttpError error when the service returns a 4XX or 5XX status code
func (m *InferenceFleetsWithFleet_ItemRequestBuilder) Get(ctx context.Context, requestConfiguration *InferenceFleetsWithFleet_ItemRequestBuilderGetRequestConfiguration) (i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.Fleetable, error) {
