...
// ByPolicy_id gets an item from the github.com/cedana/cedana-propagator-sdk/go.v1.policy.pipeline.item collection
...
// ByPolicy_idGuid gets an item from the github.com/cedana/cedana-propagator-sdk/go.v1.policy.pipeline.item collection
// returns a *PolicyPipelineWithPolicy_ItemRequestBuilder when successful
