...
// MetricsK8RequestBuilder builds and executes requests for operations under \v1\metrics\k8
...
func (m *MetricsK8RequestBuilder) Get(ctx context.Context, requestConfiguration *MetricsK8RequestBuilderGetRequestConfiguration) ([]i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.NodeResourceMetricListable, error) {
	...
	res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.CreateNodeResourceMetricListFromDiscriminatorValue, errorMapping)
	if err != nil {
		return nil, err
	}
	val := make([]i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.NodeResourceMetricListable, len(res))
	for i, v := range res {
		if v != nil {
			val[i] = v.(i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.NodeResourceMetricListable)
		}
	}
	return val, nil
}
