...
// ByName gets an item from the github.com/cedana/cedana-propagator-sdk/go.v1.dynamo.deployments.item collection
...
func (m *DynamoDeploymentsRequestBuilder) Get(ctx context.Context, requestConfiguration *DynamoDeploymentsRequestBuilderGetRequestConfiguration) ([]i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.DynamoDeploymentViewable, error) {
	...
	res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.CreateDynamoDeploymentViewFromDiscriminatorValue, errorMapping)
	if err != nil {
		return nil, err
	}
	val := make([]i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.DynamoDeploymentViewable, len(res))
	for i, v := range res {
		if v != nil {
			val[i] = v.(i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.DynamoDeploymentViewable)
		}
	}
	return val, nil
}
