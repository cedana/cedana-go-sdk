...
// JobsPaginatedRequestBuilder builds and executes requests for operations under \v1\jobs\paginated
...
func NewJobsPaginatedRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *JobsPaginatedRequestBuilder {
	m := &JobsPaginatedRequestBuilder{
		BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/v1/jobs/paginated{?ascending*,job_name*,limit*,namespace*,offset*,sort*,status*}", pathParameters),
	}
	return m
}
...
func (m *JobsPaginatedRequestBuilder) Get(ctx context.Context, requestConfiguration *JobsPaginatedRequestBuilderGetRequestConfiguration) (i89856fb30cc728ac649e5f2184f35b3dbca9c394c0e717f9e3ad3070b5506e89.PaginatedJobResponseable, error) {
