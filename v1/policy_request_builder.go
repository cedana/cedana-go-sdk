...
// ByPolicy_id gets an item from the github.com/cedana/cedana-go-sdk.v1.policy.item collection
...
// ByPolicy_idGuid gets an item from the github.com/cedana/cedana-go-sdk.v1.policy.item collection
// returns a *PolicyWithPolicy_ItemRequestBuilder when successful
