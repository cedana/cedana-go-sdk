...
func (m *MetricsPodsRequestBuilder) Get(ctx context.Context, requestConfiguration *MetricsPodsRequestBuilderGetRequestConfiguration) ([]i4db02de4fa95db6167263a0a43a6a58c23904074eb83cc381a94eba9021abdb2.PodUtilizationable, error) {
	...
	res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i4db02de4fa95db6167263a0a43a6a58c23904074eb83cc381a94eba9021abdb2.CreatePodUtilizationFromDiscriminatorValue, errorMapping)
	if err != nil {
		return nil, err
	}
