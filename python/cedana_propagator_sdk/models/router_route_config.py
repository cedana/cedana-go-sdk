...
if TYPE_CHECKING:
    from .router_target_config import RouterTargetConfig

@dataclass
class RouterRouteConfig(AdditionalDataHolder, Parsable):
    ...
    targets: Optional[list[RouterTargetConfig]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RouterRouteConfig:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RouterRouteConfig
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return RouterRouteConfig()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "targets": lambda n : setattr(self, 'targets', n.get_collection_of_object_values(RouterTargetConfig)),
        }
        return fields
