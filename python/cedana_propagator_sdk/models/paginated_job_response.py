...
@dataclass
class PaginatedJobResponse(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PaginatedJobResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "jobs": lambda n : setattr(self, 'jobs', n.get_collection_of_object_values(JobResponse)),
