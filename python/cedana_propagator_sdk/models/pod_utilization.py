...
@dataclass
class PodUtilization(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PodUtilization:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: PodUtilization
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "owner_kind": lambda n : setattr(self, 'owner_kind', n.get_str_value()),
            "owner_name": lambda n : setattr(self, 'owner_name', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("owner_kind", self.owner_kind)
        writer.write_str_value("owner_name", self.owner_name)
