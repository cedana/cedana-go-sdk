...
@dataclass
class DeploymentStep(AdditionalDataHolder, Parsable):
    """
    One recorded step in a profile's deployment, newest first.
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DeploymentStep:
        """
