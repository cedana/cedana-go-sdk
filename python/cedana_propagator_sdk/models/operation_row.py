...
@dataclass
class OperationRow(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OperationRow:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "op_type": lambda n : setattr(self, 'op_type', n.get_str_value()),
            "operation_id": lambda n : setattr(self, 'operation_id', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("op_type", self.op_type)
        writer.write_str_value("operation_id", self.operation_id)
