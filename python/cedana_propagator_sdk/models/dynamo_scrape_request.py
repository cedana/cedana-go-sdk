...
@dataclass
class DynamoScrapeRequest(AdditionalDataHolder, Parsable):
    """
    Body sent by the dynamo-watcher after scraping /v1/models from the live frontend.
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> DynamoScrapeRequest:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: DynamoScrapeRequest
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return DynamoScrapeRequest()
