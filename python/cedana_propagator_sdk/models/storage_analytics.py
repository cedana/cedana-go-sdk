...
@dataclass
class StorageAnalytics(AdditionalDataHolder, Parsable):
    ...
    incremental_ratio: Optional[float] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> StorageAnalytics:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: StorageAnalytics
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "dedup_ratio": lambda n : setattr(self, 'dedup_ratio', n.get_float_value()),
            "incremental_ratio": lambda n : setattr(self, 'incremental_ratio', n.get_float_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_float_value("dedup_ratio", self.dedup_ratio)
        writer.write_float_value("incremental_ratio", self.incremental_ratio)
