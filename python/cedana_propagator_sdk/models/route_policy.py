...
@dataclass
class RoutePolicy(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RoutePolicy:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "targets": lambda n : setattr(self, 'targets', n.get_collection_of_object_values(RouteTarget)),
        }
        return fields
