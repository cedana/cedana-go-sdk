...
if TYPE_CHECKING:
    ...
    from ....models.namespaces_response import NamespacesResponse

class NamespacesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/pods/namespaces
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/pods/namespaces", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[NamespacesResponse]:
        ...
        Returns: Optional[NamespacesResponse]
        """
    ...
    def with_url(self,raw_url: str) -> NamespacesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: NamespacesRequestBuilder
        """
        if raw_url is None:
