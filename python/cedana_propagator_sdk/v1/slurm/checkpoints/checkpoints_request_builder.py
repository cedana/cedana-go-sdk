...
if TYPE_CHECKING:
    ...
    from ....models.slurm_checkpoint import SlurmCheckpoint
...
class CheckpointsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/slurm/checkpoints
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/slurm/checkpoints{?cluster_id*,ids*,job_id*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[CheckpointsRequestBuilderGetQueryParameters]] = None) -> Optional[list[SlurmCheckpoint]]:
        """
        Use query params to filter checkpoints. Supports filtering by `ids` (comma-separated UUIDsfor single or multiple checkpoints), `job_id` and `cluster_id`
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[SlurmCheckpoint]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, SlurmCheckpoint, error_mapping)
