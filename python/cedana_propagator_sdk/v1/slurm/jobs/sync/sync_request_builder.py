...
if TYPE_CHECKING:
    ...
    from .....models.slurm_job_sync_request import SlurmJobSyncRequest

class SyncRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/slurm/jobs/sync
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/slurm/jobs/sync", path_parameters)
