...
if TYPE_CHECKING:
    ...
    from ....models.total_count_response import TotalCountResponse

class CountRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/cluster/count
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/cluster/count{?status*}", path_parameters)
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[CountRequestBuilderGetQueryParameters]] = None) -> Optional[TotalCountResponse]:
        ...
        Returns: Optional[TotalCountResponse]
        """
