...
if TYPE_CHECKING:
    ...
    from ....models.pod_utilization import PodUtilization
    from .top.top_request_builder import TopRequestBuilder

class PodsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/metrics/pods
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/metrics/pods{?hours*,limit*,node_name*,pod_uid*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[PodsRequestBuilderGetQueryParameters]] = None) -> Optional[list[PodUtilization]]:
        """
        Get pod utilization metrics
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[PodUtilization]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, PodUtilization, error_mapping)
