...
if TYPE_CHECKING:
    ...
    from ....models.node_resource_metric_list import NodeResourceMetricList

class K8RequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/metrics/k8
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new K8RequestBuilder and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[NodeResourceMetricList]]:
        ...
        Returns: Optional[list[NodeResourceMetricList]]
        """
    ...
    def with_url(self,raw_url: str) -> K8RequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: K8RequestBuilder
        """
        if raw_url is None:
