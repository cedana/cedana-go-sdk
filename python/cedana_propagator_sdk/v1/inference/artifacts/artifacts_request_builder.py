...
if TYPE_CHECKING:
    ...
    from ....models.register_artifact import RegisterArtifact
    from .item.with_artifact_item_request_builder import WithArtifact_ItemRequestBuilder

class ArtifactsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/inference/artifacts
    """
    ...
    def by_artifact_id(self,artifact_id: str) -> WithArtifact_ItemRequestBuilder:
        """
        Gets an item from the cedana_propagator_sdk.v1.inference.artifacts.item collection
        param artifact_id: Unique identifier of the item
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[ArtifactsRequestBuilderGetQueryParameters]] = None) -> Optional[list[CheckpointArtifactView]]:
        ...
        Returns: Optional[list[CheckpointArtifactView]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, CheckpointArtifactView, error_mapping)
    
    async def post(self,body: RegisterArtifact, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CheckpointArtifactView]:
        """
    ...
    def to_post_request_information(self,body: RegisterArtifact, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Register a checkpoint artefact
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    @dataclass
    class ArtifactsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
