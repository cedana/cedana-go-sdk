...
class AnalyticsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/inference/analytics{?experiment_id*,hours*,profile_id*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[AnalyticsRequestBuilderGetQueryParameters]] = None) -> Optional[InferenceAnalytics]:
        """
