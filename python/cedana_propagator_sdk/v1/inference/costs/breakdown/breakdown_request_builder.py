...
if TYPE_CHECKING:
    from .....models.cost_breakdown_row import CostBreakdownRow
    from .....models.http_error import HttpError

class BreakdownRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/inference/costs/breakdown
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new BreakdownRequestBuilder and sets the default values.
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[BreakdownRequestBuilderGetQueryParameters]] = None) -> Optional[list[CostBreakdownRow]]:
        ...
        Returns: Optional[list[CostBreakdownRow]]
        """
    ...
    def with_url(self,raw_url: str) -> BreakdownRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: BreakdownRequestBuilder
        """
        if raw_url is None:
