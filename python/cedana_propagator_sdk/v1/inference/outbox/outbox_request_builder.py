...
if TYPE_CHECKING:
    ...
    from .ack.ack_request_builder import AckRequestBuilder

class OutboxRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/inference/outbox
    """
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[OutboxRequestBuilderGetQueryParameters]] = None) -> Optional[list[OutboxEvent]]:
        ...
        Returns: Optional[list[OutboxEvent]]
        """
    ...
    def with_url(self,raw_url: str) -> OutboxRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: OutboxRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return OutboxRequestBuilder(self.request_adapter, raw_url)
    
    @property
    def ack(self) -> AckRequestBuilder:
        """
        The ack property
        """
        from .ack.ack_request_builder import AckRequestBuilder
