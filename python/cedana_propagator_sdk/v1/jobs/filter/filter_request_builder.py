...
if TYPE_CHECKING:
    from ....models.filtered_job_response import FilteredJobResponse
    from ....models.http_error import HttpError

class FilterRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /v1/jobs/filter
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/v1/jobs/filter{?namespace*,priority*,status*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[FilterRequestBuilderGetQueryParameters]] = None) -> Optional[FilteredJobResponse]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[FilteredJobResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, FilteredJobResponse, error_mapping)
