...
// DynamoDeploymentsRequestBuilder builds and executes requests for operations under \v2\dynamo\deployments
...
// ByName gets an item from the github.com/cedana/cedana-go-sdk.v2.dynamo.deployments.item collection
...
func NewDynamoDeploymentsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*DynamoDeploymentsRequestBuilder) {
    m := &DynamoDeploymentsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/v2/dynamo/deployments?cluster_id={cluster_id}{&namespace*}", pathParameters),
    }
    return m
}
