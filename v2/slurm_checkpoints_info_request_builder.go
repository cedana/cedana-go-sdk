...
// SlurmCheckpointsInfoRequestBuilder builds and executes requests for operations under \v2\slurm\checkpoints\info
type SlurmCheckpointsInfoRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ById gets an item from the github.com/cedana/cedana-go-sdk.v2.slurm.checkpoints.info.item collection
...
// ByIdGuid gets an item from the github.com/cedana/cedana-go-sdk.v2.slurm.checkpoints.info.item collection
// returns a *SlurmCheckpointsInfoInfoItemRequestBuilder when successful
...
func NewSlurmCheckpointsInfoRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*SlurmCheckpointsInfoRequestBuilder) {
    m := &SlurmCheckpointsInfoRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/v2/slurm/checkpoints/info", pathParameters),
    }
    return m
}
